...
class TestscenarioRestTjenesteTest {

    @Test
    void roundtripTestAvOpprettingAvTestcenario() {
        var personRepository = new PersonRepository();
        var testscenarioV2RestTjeneste = new TestscenarioRestTjeneste(personRepository);

        var fiktivFnrGen = new FiktiveFnr();

        var morID = fiktivFnrGen.tilfeldigKvinneFnr();
        var farID = fiktivFnrGen.tilfeldigMannFnr();
        var barnID = fiktivFnrGen.tilfeldigBarnUnderTreAarFnr();
        var privateAG = fiktivFnrGen.tilfeldigFnr();
