...
public class TestscenarioRestTjeneste {
    ...
    public Response initialiserTestscenarioReturnerIdenter(List<PersonDto> personer) {
        ...
        var personerMapped = personer.stream()
                .map(p -> PersonMapper.tilPerson(p, identer, eksisterendePersoner.get(p.personopplysninger().uuid())))
                .toList();
