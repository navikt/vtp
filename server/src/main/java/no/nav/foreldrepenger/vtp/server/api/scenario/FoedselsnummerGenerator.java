...
public class FoedselsnummerGenerator {
    ...
    private FoedselsnummerGenerator(Builder fgb){
        this.kjonn = Objects.requireNonNullElseGet(fgb.kjonn, FoedselsnummerGenerator::randomKjonn);
        this.fodselsdato = Objects.requireNonNullElseGet(fgb.fodselsdato, FoedselsnummerGenerator::generateRandomPlausibleBirtdayParent);
    }
