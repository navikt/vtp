...
public class OppgavebehandlingServiceMockImpl implements OppgavebehandlingV3 {
    ...
    public void feilregistrerOppgave(@WebParam(name = "request",targetNamespace = "") FeilregistrerOppgaveRequest feilregistrerOppgaveRequest) throws FeilregistrerOppgaveOppgaveIkkeFunnet, FeilregistrerOppgaveUlovligStatusOvergang {
    ...
    public void lagreOppgave(@WebParam(name = "request",targetNamespace = "") LagreOppgaveRequest lagreOppgaveRequest) throws LagreOppgaveOppgaveIkkeFunnet, LagreOppgaveOptimistiskLasing {
        throw new UnsupportedOperationException("Ikke implementert");
    }
    ...
    public void slettMappe(@WebParam(name = "request",targetNamespace = "") SlettMappeRequest slettMappeRequest) throws SlettMappeMappeIkkeFunnet, SlettMappeMappeIkkeTom {
        throw new UnsupportedOperationException("Ikke implementert");
    ...
    public TildelOppgaveResponse tildelOppgave(@WebParam(name = "request",targetNamespace = "") TildelOppgaveRequest tildelOppgaveRequest) throws TildelOppgaveUgyldigInput {
        throw new UnsupportedOperationException("Ikke implementert");
    }
}
