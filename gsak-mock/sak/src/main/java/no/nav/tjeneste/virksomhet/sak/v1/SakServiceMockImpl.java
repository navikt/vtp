...
public class SakServiceMockImpl implements SakV1 {
    ...
    private static final GsakRepo GSAK_REPO = GsakRepo.init();
    ...
    public FinnSakResponse finnSak(
        ...
        List<Sak> resultList = GSAK_REPO.getAlleSaker().stream()
    ...
    public HentSakResponse hentSak(
        ...
        response.setSak(GSAK_REPO.hentSak(request.getSakId()));
        return response;
