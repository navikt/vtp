...
import no.nav.tjeneste.virksomhet.sak.v1.modell.GsakRepo;
...
public class SakServiceMockImpl implements SakV1 {
    ...
    public FinnSakResponse finnSak(
        ...
        List<Sak> resultList = new GsakRepo().finnSak(request);
        return new FinnSakResponse(){
            {this.sakListe= resultList;}
        };
    }
    ...
    public HentSakResponse hentSak(
        ...
        response.setSak(new GsakRepo().hentSak(request.getSakId()));
        return response;
