...
public class FordelingErketyper {
    ...
    public static Fordeling fordelingMorHappyCase(LocalDate familehendelseDato) {
        ...
        fordeling.getPerioder().add(uttaksperiode(STØNADSKONTOTYPE_FORELDREPENGER_FØR_FØDSEL, familehendelseDato.minusWeeks(3), LocalDate.now()));
        fordeling.getPerioder().add(uttaksperiode(STØNADSKONTOTYPE_MØDREKVOTE, LocalDate.now(), LocalDate.now().plusWeeks(6)));
