...
public class LukketPeriodeConverter<T extends LukketPeriodeDto> {

    private ModelMapper mapper;
    public LukketPeriodeConverter(ModelMapper mapper) {
        this.mapper = mapper;
    }

    protected LukketPeriode konverter(T lukketPeriodeDto) {
