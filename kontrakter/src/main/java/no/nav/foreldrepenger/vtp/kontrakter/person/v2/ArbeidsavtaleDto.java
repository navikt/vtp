...
public record ArbeidsavtaleDto(Integer avtaltArbeidstimerPerUke,
    ...
    private ArbeidsavtaleDto(Builder b) {
        this(b.avtaltArbeidstimerPerUke, b.stillingsprosent, b.beregnetAntallTimerPerUke,
                b.sisteLønnsendringsdato, b.fomGyldighetsperiode, b.tomGyldighetsperiode);
    }
