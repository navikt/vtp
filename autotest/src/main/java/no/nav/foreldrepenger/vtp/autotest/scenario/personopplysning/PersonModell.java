package no.nav.foreldrepenger.vtp.autotest.scenario.personopplysning;

import com.fasterxml.jackson.annotation.JacksonInject;
import com.fasterxml.jackson.annotation.JsonInclude;
import com.fasterxml.jackson.annotation.JsonInclude.Include;
import com.fasterxml.jackson.annotation.JsonProperty;
import no.nav.foreldrepenger.vtp.autotest.scenario.medlemskap.MedlemskapModell;
...
public abstract class PersonModell extends BrukerModell {
    ...
    public PersonstatusModell getPersonstatus() {
        return personstatus.isEmpty() ? new PersonstatusModell(PersonstatusModell.Personstatuser.BOSA) : personstatus.get(0);
    }
