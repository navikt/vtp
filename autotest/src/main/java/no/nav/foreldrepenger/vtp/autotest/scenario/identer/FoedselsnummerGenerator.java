package no.nav.foreldrepenger.vtp.autotest.scenario.identer;

import no.nav.foreldrepenger.vtp.autotest.scenario.enums.IdentType;
import no.nav.foreldrepenger.vtp.autotest.scenario.enums.Kjonn;
