...
@Api(tags = {"tjenestepensjon/simuler/test"})
@Path("/api/test")
public class SimulerOffentligTjenestepensjonTjeneste {
    private static final Logger LOG = LoggerFactory.getLogger(SimulerOffentligTjenestepensjonTjeneste.class);

    TestscenarioRepositoryImpl testscenarioRepository;

    public SimulerOffentligTjenestepensjonTjeneste() {
        try {
