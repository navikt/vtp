...
class PersonhistorikkMockCase5 {
    ...
    private HentPersonhistorikkResponse mockedPerson(HentPersonhistorikkResponse response) {
        response.withPersonstatusListe(personstatusPerson5());
        response.withStatsborgerskapListe(personStatsborgerskapPerson5());
        response.withBostedsadressePeriodeListe(personNorskAdresserPerson5());

        return response;
    }

    private List<PersonstatusPeriode> personstatusPerson5() {
    ...
    private List<StatsborgerskapPeriode> personStatsborgerskapPerson5() {
    ...
    private List<BostedsadressePeriode> personNorskAdresserPerson5() {
