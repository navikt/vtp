...
import static no.nav.tjeneste.virksomhet.journal.modell.JournalDokumentKonstanter.FEILKODE_KAN_IKKE_BEHANDLES;
...
public class InngaaendeJournalServiceMockImpl implements InngaaendeJournalV1 {
    ...
    public InngaaendeJournalServiceMockImpl(Repository scenarioRepository){
    ...
    public HentJournalpostResponse hentJournalpost(@WebParam(name = "request", targetNamespace = "") HentJournalpostRequest request)
        ...
        List<JournalDokument> journalDokListe = joarkScenarioTjeneste.finnDokumenterMedJournalId(journalpostId);
        ...
        Journalpost journalpost = journalpostModelData.getJournalpostForId(journalpostId);
    ...
    public UtledJournalfoeringsbehovResponse utledJournalfoeringsbehov(@WebParam(name = "request", targetNamespace = "") UtledJournalfoeringsbehovRequest request)
        ...
        // Let i db og returner det som evt. funnet der:
        List<JournalDokument> journalDokListe = joarkScenarioTjeneste.finnDokumenterMedJournalId(request.getJournalpostId());
