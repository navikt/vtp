...
public final class JournalpostSelvbetjeningBuilder {
    ...
    private static Journalstatus tilJournalStatus(no.nav.vtp.journalpost.dokument.modell.koder.Journalstatus journalStatus) {
        if (no.nav.vtp.journalpost.dokument.modell.koder.Journalstatus.JOURNALFØRT.equals(journalStatus)) return Journalstatus.JOURNALFOERT;
        if (no.nav.vtp.journalpost.dokument.modell.koder.Journalstatus.MOTTATT.equals(journalStatus)) return Journalstatus.MOTTATT;
        if (no.nav.vtp.journalpost.dokument.modell.koder.Journalstatus.AVBRUTT.equals(journalStatus)) return Journalstatus.AVBRUTT;
        if (no.nav.vtp.journalpost.dokument.modell.koder.Journalstatus.MIDLERTIDIG_JOURNALFØRT.equals(journalStatus)) {
