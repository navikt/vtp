...
public class BehandleSak2ServiceMockImpl implements BehandleSakV2 {
    ...
    public no.nav.tjeneste.virksomhet.behandlesak.v2.WSOpprettSakResponse opprettSak(@WebParam(name = "opprettSakRequest", targetNamespace = "") no.nav.tjeneste.virksomhet.behandlesak.v2.WSOpprettSakRequest request)
